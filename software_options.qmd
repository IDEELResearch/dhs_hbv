...
formula_spatial <- deaths ~ 1 + f(provincia_id, model = "bym", graph = G) #above model is iid, here bym, need extra step to give adjacency matrix
model_spatial <- inla(
  formula_spatial,
  data = data,
  E = expected,
...
formula_spatial <- deaths ~ 1 + f(provincia_id, model = "besag", graph = G) #above model is iid, here bym, need extra step to give adjacency matrix
model_spatial <- inla(
  formula_spatial,
  data = data,
  E = expected,
